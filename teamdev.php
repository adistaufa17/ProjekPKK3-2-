...
<div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="menu-item active"><a href="teamdev.php"><i class="fas fa-users"></i><span class="menu-text">Team Developer</span></a></li>     
  ...
  <div class="main-content">
    <div class="content-container">
      <h1 class="text-4xl font-bold text-center mb-12 border-b-4 border-white-600 pb-2" style="color: wheat;">OUR INCREDIBLE TEAMS</h1>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Leadership -->
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Leadership</h2>
          <img src="" alt="Ezar" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
          ...
          <a href="" target="_blank" class="mt-3 inline-block text-pink-500 hover:text-pink-700">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          ...
          <img src="" alt="Felix" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          ...
          <img src="" alt="Adista" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Software Development</h2>
          <img src="" alt="Akmal" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Software Development</h2>
          <img src="" alt="Shera" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          ...
          <img src="" alt="Royan" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Design</h2>
          <img src="" alt="Jelita" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Design</h2>
          <img src="" alt="Mufi" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          ...
          <img src="" alt="Maid" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Data Analysis</h2>
          <img src="" alt="Nisfu" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          ...
          <img src="" alt="Yuki" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
        ...
        <div class="team-card bg-white rounded-xl shadow p-6 text-center">
          <h2 class="text-2xl font-semibold text-blue-700 border-b-2 border-green-400 pb-2 mb-6">Marketing</h2>
          <img src="" alt="Revaldo" class="w-32 h-32 rounded-full mx-auto mb-4 object-cover">
